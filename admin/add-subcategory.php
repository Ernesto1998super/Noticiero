...
<html lang="en">
    <head>
        ...
        <title>Newsportal | Agregar sub categoría </title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title"> Agregar subcategoría </h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li class="active"> Agregar subcategoría
                                        </li>
                                    </ol>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b> Agregar subcategoría </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label"> Descripción de la subcategoría </label>
	                                                <div class="col-md-10">
