...
<html lang="en">
    <head>
        ...
        <title>Newsportal | Editar subcategoría</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Agregar Sub-Categoria</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Añadir Sub-Categoria </b></h4>
                                    <hr />
...
Descripción de la subcategoría</label>
	                                                <div class="col-md-10">
