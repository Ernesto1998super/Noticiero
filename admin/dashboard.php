                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics"> Categorías enumeradas </p>
...
<a href="manage-subcategories.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month"> Subcategorías enumeradas </p>
     ...
     <a href="manage-posts.php">                       
        <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month"> Noticias en vivo </p>
   ...
   <div class="row">
      ...
      <a href="trash-posts.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month"> Noticias de basura </p>
...
<?php include('includes/footer.php');?>
            ...
            <div class="side-bar right-bar">
                ...
                <div class="setting-list nicescroll">
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Acceso API</h5>
                            <p class="m-b-0 text-muted"><small> Habilitar / deshabilitar el acceso </small></p>
                        </div>
                        <div class="col-xs-4 text-right">
                            <input type="checkbox" checked data-plugin="switchery" data-color="#7fc1fc" data-size="small"/>
                        </div>
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            ...
                            <p class="m-b-0 text-muted"><small> Muestre su estado a todos </small></p>
                        </div>
                        <div class="col-xs-4 text-right">
                            <input type="checkbox" checked data-plugin="switchery" data-color="#7fc1fc" data-size="small"/>
                        </div>
