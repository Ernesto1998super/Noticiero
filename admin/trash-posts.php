...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Administrar publicaciones</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Publicaciones en la papelera </h4>
...
<td colspan="4" align="center"><h3 style="color:red"> Ningún record fue encontrado</h3></td>
<tr>
<?php 
} else {
