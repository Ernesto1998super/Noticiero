...
<html lang="en">
    <head>
        ...
        <title>Newsportal | Añadir Categoría</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Agregar Categoría</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Agregar Categoría </b></h4>
                                    <hr />
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label"> Descripción de categoría</label>
	                                                <div class="col-md-10">
