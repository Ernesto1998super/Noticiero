...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Agregar publicación</title>
...
<label for="exampleInputEmail1">Título de la entrada</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b> Imagen de nueva función</b></h4>
