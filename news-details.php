...
?>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <p><b>Categoria : </b> <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['category']);?></a> |
                <b>Sub Categoria : </b><?php echo htmlentities($row['subcategory']);?> <b> Publicado en </b><?php echo htmlentities($row['postingdate']);?></p>
                <hr />
